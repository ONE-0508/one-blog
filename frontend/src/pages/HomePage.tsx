    ...
    <div className="grid gap-6 lg:grid-cols-[minmax(0,2.2fr)_minmax(0,1fr)] lg:items-start">
      <MainContent>
        <section className="space-y-6">
          <div className="relative overflow-hidden rounded-3xl border border-border-subtle bg-bg-elevated-soft/70 p-6">
          ...
          <div className="flex flex-wrap gap-3">
            <MotionLink
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center justify-center rounded-full bg-accent-primary px-5 py-2 text-xs font-semibold text-accent-contrast shadow-subtle hover:brightness-105 md:text-sm"
            >
              浏览最新文章
            </MotionLink>
            <MotionLink
